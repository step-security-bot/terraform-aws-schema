...
const awsShieldDrtAccessRoleArnAssociation = `{
  "block": {
    "attributes": {
      "id": {
        "computed": true,
...
func AwsShieldDrtAccessRoleArnAssociationSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(awsShieldDrtAccessRoleArnAssociation), &result)
	return &result
}
