...
import (
	...
	"github.com/lonegunmanb/terraform-aws-schema/v3/schema"
	"golang.org/x/oauth2"
)
...
func checkGitHubTag(schemaVersion string) (bool, error) {
	...
	for {
		tags, resp, err := client.Repositories.ListTags(context.Background(), "lonegunmanb", "terraform-aws-schema", options)
		if err != nil {
			return false, err
		}
